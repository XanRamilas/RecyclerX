...
/**
 * The callback interface is for listening to clicks on an item like self view holder or other views in a view holder
 *
 * @author Vadim Firsov
 */
public interface RecyclerViewItemClickListener {
    ...
    /**
     * It is called at click on a view holder
     *
     ...
     */
    void onItemClick(@NonNull RecyclerView.ViewHolder viewHolder, int position, int viewType, int viewId);
}